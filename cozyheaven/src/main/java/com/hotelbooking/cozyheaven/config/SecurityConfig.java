	...
	SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
		http.csrf(csrf -> csrf.disable())
				.authorizeHttpRequests((authorize) -> authorize.requestMatchers("api/auth/signup").permitAll()
						...
						.requestMatchers("api/hotel/get/{hotelownerid}").hasAnyAuthority("Admin","HotelOwner")
						.requestMatchers("api/hotel/get/{hotelid}").hasAnyAuthority("Admin","HotelOwner")
						...
						.requestMatchers("api/hotel/review/{hotelid}").hasAuthority("HotelOwner")
						.requestMatchers("api/hotel/review/{ownerid}").hasAuthority("HotelOwner")
