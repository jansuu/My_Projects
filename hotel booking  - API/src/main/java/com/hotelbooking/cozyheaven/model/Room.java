	...
	public class Room {
		...
		public Room(int id, String name, double pricePerNight, int maxCapacity, String aminities,
				RoomAvailabilityStatus availabilityStatus, RoomType type, String imageUrls, Hotel hotel) {
			super();
			this.id = id;
			this.name = name;
			this.pricePerNight = pricePerNight;
		...
		public Room(String name, double pricePerNight, int maxCapacity, String aminities,
				RoomAvailabilityStatus availabilityStatus, RoomType type, String imageUrls, Hotel hotel) {
			super();
			this.name = name;
			this.pricePerNight = pricePerNight;
