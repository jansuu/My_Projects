...
public class Hotel {
	...
	public Hotel(String name, HotelType type, String description, String address, String city, String state, String zip,
			String country, String contactEmail, String contact, String imageUrls, HotelStatus status,
			HotelAvailability isAvailable, String commonAmenities, String licenseDetails, String propertyProofDetails,
			Double starRating, LocalDateTime createdAt, LocalDateTime approvedAt, DeletionRequest deletionRequested,
			HotelOwner hotelOwner) {
		super();
